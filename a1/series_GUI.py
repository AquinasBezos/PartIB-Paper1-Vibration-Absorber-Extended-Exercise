...
class GUI:
    ...
    # parameter in this code, and the parameter name in the call to series.plot().
    ...
    def __init__(self):
        ...
        self.diagram_1dof = tkinter.PhotoImage(
            file=prog_dir / 'series_diagram_1dof.png'
        )
        self.diagram_2dof = tkinter.PhotoImage(
            file=prog_dir / 'series_diagram_2dof.png'
        )
    ...
    def plot(self):
        ...
        if self.enabled_2dof.get() == 0:
            args = self.keys_1dof
            MKLF = series.MLKF_1dof
            kwargs = {}
        else:
            args = f'{self.keys_1dof},{self.keys_2dof}'
            MKLF = series.MLKF_2dof
            kwargs = {'f2': 0}
