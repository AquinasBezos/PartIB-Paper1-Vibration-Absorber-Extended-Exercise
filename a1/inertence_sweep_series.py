...
from series import MLKF_2dof, freq_response, time_response, last_nonzero
...
def main():
    ...
    # System parameters (with defaults from series.py)
    ...
    parser.add_argument('--b1-range', type=float, nargs=3, default=[0, 15, 15],
                        help='Range for b1 [min, max, steps]')
    parser.add_argument('--b2-range', type=float, nargs=3, default=[0, 15, 15],
